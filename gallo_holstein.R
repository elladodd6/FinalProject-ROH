...
####R script to identify genes in the regions of homozygosity
  ####uses the R package GALLO
      ####requires a table containing a column for chromsome (CHR) and base pairs (BP) and a .gtf file from ensembl on the species
      ####can search by gene or qtl using snps or haplotypes
      
      ####for reference: https://cran.r-project.org/web/packages/GALLO/GALLO.pdf
...
DT::datatable(hol_gene, rownames = FALSE, 
 ...
 #######easiest visualization of this table is using an R Markdown html file
